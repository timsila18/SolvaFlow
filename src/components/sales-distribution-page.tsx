  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-white/70 bg-white/75 p-5 shadow-panel backdrop-blur lg:p-6">
        ...
        <div>
          <div className="module-kicker">Sales & Distribution</div>
          <h1 className="mt-2 text-4xl font-black tracking-normal text-solva-ink">{config.title}</h1>
          <p className="mt-2 max-w-3xl text-sm font-medium text-slate-600">Tenant-isolated sales operations connected to customers, stock availability, dispatch, delivery proof, audit trail, and notifications.</p>
        </div>
