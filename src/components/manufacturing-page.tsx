    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm text-slate-600">Tenant-isolated production records with audit logging, workflow actions, costing, QC status, and traceability.</p>
        </div>
        <form
          onSubmit={(event) => {
            event.preventDefault();
      ...
      <section className="rounded-md border border-solva-line bg-white shadow-panel">
        <div className="flex items-center gap-3 border-b border-solva-line px-4 py-3">
          <Factory className="h-4 w-4 text-solva-blue" />
      ...
      {availability.length > 0 && (
        <section className="rounded-md border border-solva-line bg-white shadow-panel">
          <div className="border-b border-solva-line px-4 py-3 font-bold">Material Availability</div>
