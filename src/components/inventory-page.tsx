    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm text-slate-600">Tenant-isolated warehouse records connected to stock balances, ledger, approvals, audit trail, and notifications.</p>
        </div>
